//𝑻𝒉𝒊𝒔 𝒑𝒓𝒐𝒋𝒆𝒄𝒕 𝒊𝒔 𝒃𝒚 𝑯𝒖𝒂 𝒂𝒏𝒅 𝒖𝒔𝒊𝒏𝒈 𝑬𝒂𝒔𝒚𝒙
...
DWORD crowy[3] = {
	960 / 4 * 3 - 100 , 960 / 4 * 3 - 72 + 34 , 960 / 4 * 3 + 86 - 72
};//制作成数组方便随机出乌鸦的高度
...
void init()
{
	...
	settextstyle(33, 15, "Microsoft Yahei");
	...
	outtextxy(1600 / 2 - 20 - 155, 960 / 2 + 50, "    按空格键即可开始游戏");
...
// 绘制恐龙
void draw_dinosaur_once(int ofstx, int ofsty, bool nojump, bool bend)
{
...
int main()
{
	initgraph(1610, 960);
	HWND hWnd = GetHWnd();
	SetWindowPos(hWnd, HWND_TOPMOST, 0, 0, 1610, 960, SWP_SHOWWINDOW);
	// 进行准备，包括字体设置
	init();
